...
set n=1
:WHILE_1
set "DATA1=!n!"& set "DATA2=50"& if not !DATA1! leq !DATA2! goto END_WHILE_1
set m=1
:WHILE_2
set "DATA1=!m!"& set "DATA2=10"& if not !DATA1! leq !DATA2! goto END_WHILE_2
echo !m!
call :PROGRAM_DATA "!m!+1"& set m=!DATA!
goto :WHILE_2
:END_WHILE_2
echo ------------------ !n!
call :PROGRAM_DATA "!n!+1"& set n=!DATA!
set "DATA1=!n!"& set "DATA2=10"& if !DATA1! equ !DATA2! (
goto :END_WHILE_1
)
goto :WHILE_1
:END_WHILE_1
